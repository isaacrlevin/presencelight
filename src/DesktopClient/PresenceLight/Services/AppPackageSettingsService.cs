...
namespace PresenceLight.Services
{
    public class AppPackageSettingsService : ISettingsService
    {
        ...
        public async Task<BaseConfig?> LoadSettings()
        {
            ...
            {
                _logger.LogError(SettingsHandlerBase.Config, e, "Error saving Settings");
        ...
        public async Task<bool> DeleteSettings()
        {
            ...
            {
                _logger.LogError(SettingsHandlerBase.Config, e, "Error Deleting Settings File");
                _diagClient.TrackException(e);
                return false;
            }
        }
        ...
        public async Task<bool> IsFilePresent()
        {
            ...
            {
                _logger.LogError(SettingsHandlerBase.Config, e, "Error Finding Settings File");
                _diagClient.TrackException(e);
                return false;
            }
        }
